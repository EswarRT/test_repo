...
def convert_oracle_to_snowflake(oracle_procedure):
    ...
    for param in parameters.split(','):
        ...
        param_type = param_parts[1]  # Fixed the index to 1 for type
...
BEGIN
    update_supplier_contact(2, 'Eswar', 'jane.smith@betaltd.com');
END;
/
"""
...
execute_sql("CALL update_supplier_contact(2, 'Eswar', 'jane.smith@betaltd.com');")
