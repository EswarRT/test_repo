...
CREATE OR REPLACE PROCEDURE get_employee_by_id (
    ...
    o_hiredate      OUT employees.hiredate%TYPE
)
IS
BEGIN
    SELECT first_name, last_name, department_id, salary, hiredate
    INTO o_first_name, o_last_name, o_department_id, o_salary, o_hiredate
    FROM employees
